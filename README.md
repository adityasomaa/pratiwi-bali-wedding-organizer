# Pratiwi Bali Wedding Organizer

Marketing site for a wedding organizer in Denpasar, Bali. Built as a **reusable template**: everything that differs between clients lives in one config file, and nothing else in the codebase hardcodes a client detail.

Live: https://pratiwi-bali-wedding-organizer.onyxcreative.asia
